...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v1.3.1-blue?style=flat-square" alt="Version" />
...
<p align="center">
  ...
  ·
  <a href="https://github.com/gwennsteglik252-create/sciflow-downloads/releases/tag/v1.3.1">GitHub Release 备用下载</a>
</p>
...
- 💻 **跨平台** — 支持 macOS (Apple Silicon)、Windows 和 Android 移动端伴侣
- 🔌 **开放 API / Agent 工作流** — 内置本地 HTTP Server、Codex 技能包与自动化工作流接口

---

## 🆕 v1.3.1 最新发布

SciFlow Pro v1.3.1 是一次面向真实科研工作流的综合升级：从“能记录项目”进一步走向“能连续推进课题、沉淀实验、分析数据、生成图文成果”的本地优先科研工作站。本补丁同时修复开发调试时登录状态恢复与退出云端登录的状态判断。

- **课题中心升级**：强化研究看板、项目总览、里程碑、周计划、阶段报告、KPI/健康度评估与课题归档，帮助 PI 和研究者从全局掌握项目进展。
- **实验流程闭环**：优化工艺路线、实验矩阵、样品矩阵、DOE 迭代、步骤现象记录、试剂消耗与库存联动，让“计划 → 实验 → 记录 → 复盘”能在同一项目上下文中完成。
- **表征与数据分析增强**：围绕 XRD、XPS、BET/BJH、RDE、电化学与电池验证等场景，支持数据导入、指标提取、图谱解读、对标分析和实验记录回填。
- **文献、知识库与综述工作流**：加强文献检索、PDF 精读、情报档案、知识沉淀、综述图组装配与引用管理，把文献证据直接连接到实验设计和论文写作。
- **写作与科研绘图增强**：写作工坊、文献绘图、综述绘图、图表拼版、流程图、机理图、时间线和桑基图等模块进一步整合，面向论文、汇报和阶段总结输出。
- **AI Agent 与本地自动化**：继续强化本地 HTTP API、Codex skills、规则工作流、文件监听和自动化接口，支持外部 Agent 与 SciFlow 项目数据协同。
- **授权与分发规范化**：源码仓库保持私有，公开仓库仅提供 README、LICENSE、EULA、展示截图和安装包；桌面端更新入口指向公开 Release，软件声明为 Proprietary / All Rights Reserved。

## 📦 下载安装

> 镜像下载页：[https://gwennsteglik252-create.github.io/sciflow-downloads/](https://gwennsteglik252-create.github.io/sciflow-downloads/)  
> 说明：当前镜像页只发布下载入口、授权说明和展示截图；安装包直连 CDN 尚未接入，页面内仍保留 GitHub Release 作为备用下载。

| 平台 | 下载链接 | 系统要求 |
|:----:|---------|---------|
| 🍎 **macOS** | [SciFlow-Pro-v1.3.1-arm64.dmg](https://github.com/gwennsteglik252-create/sciflow-downloads/releases/download/v1.3.1/SciFlow-Pro-1.3.1-arm64.dmg) | macOS 12+ (Apple Silicon) |
| 🪟 **Windows** | [SciFlow-Pro-Setup-v1.3.1.exe](https://github.com/gwennsteglik252-create/sciflow-downloads/releases/download/v1.3.1/SciFlow-Pro-Setup-1.3.1.exe) | Windows 10/11 (64-bit) |
| 📱 **Android** | [SciFlow-Pro-v1.3.1-android.apk](https://github.com/gwennsteglik252-create/sciflow-downloads/releases/download/v1.3.1/SciFlow-Pro-1.3.1-android.apk) | Android 8+ |

## 🔐 授权与许可

SciFlow Pro 是专有软件，保留所有权利。下载安装包不代表获得源码授权，也不允许未经授权复制、修改、分发、转售、反向工程或绕过激活机制。完整条款请阅读 [LICENSE](./LICENSE) 和 [EULA.md](./EULA.md)。
...
- 🛠️ **账号登录修复**：开发调试不再用免登录模式覆盖真实 Supabase session；已登录账号可在重启后恢复，账号安全页可正常执行退出云端登录。

### v1.3.0 (2026-06-01)
🧬 **科研全流程工作站强化版**

**🆕 产品能力更新**
- 🧭 **课题中心与研究看板增强**：强化项目总览、里程碑、周计划、项目报告、归档库和 KPI/健康度评估，支持从课题立项到阶段复盘的连续管理。
- 🧪 **实验执行闭环升级**：完善工艺路线、实验矩阵、样品矩阵、DOE 迭代、步骤现象记录、试剂消耗和库存联动，减少实验计划、记录和复盘之间的信息断层。
- 🔬 **表征与电化学分析扩展**：面向 XRD、XPS、BET/BJH、RDE、电化学和电池验证场景，支持图谱导入、指标提取、结果解读、对标分析和实验记录回填。
- 📚 **文献与知识库工作流增强**：强化文献检索、PDF 精读、情报档案、知识沉淀和综述图组装配，让文献证据更容易回到实验设计与论文写作中。
- ✍️ **写作与科研绘图整合**：写作工坊、文献绘图、综述绘图、图表拼版、流程图、机理图、时间线和桑基图等输出链路进一步串联。
- 🤖 **AI Agent 与本地自动化增强**：保留本地优先架构，继续扩展本地 HTTP API、Codex skills、规则工作流、文件监听和外部 Agent 协作接口。

**🔐 发布与授权更新**
- 🔒 **源码仓库私有化**：源码与构建配置保留在私有仓库，公开仓库只提供 README、LICENSE、EULA、展示截图和安装包。
- 📦 **公开下载仓库**：Windows、macOS、Android 安装包统一发布到 `sciflow-downloads`。
- 🛡️ **专有授权声明**：README、LICENSE、EULA 和发布说明统一标注 Proprietary / All Rights Reserved，不再标注 MIT 开源授权。
- 🔄 **更新入口修正**：桌面端自动更新检查和下载页面指向公开 Release。
...
| 渠道 | 说明 |
|:----:|:-----|
| 🐛 **Bug 反馈** | [提交 Issue](https://github.com/gwennsteglik252-create/sciflow-downloads/issues) |
| 💡 **功能建议** | [提交 Feature Request](https://github.com/gwennsteglik252-create/sciflow-downloads/issues/new?labels=enhancement) |
| 📧 **商务合作** | 请通过 Issue 联系 |
